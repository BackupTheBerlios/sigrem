...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
	...
	<div id="sectionLinks">
    <a href="RecursosList.do">Volver atrás</a>	
    </div>
	<div id="error">
	<html:errors />
	</div>
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="ContratosList.do">Contratos</a> > <a href="MultasList.do">Ver Multas</a> > <a href="RecursosList.do">Ver recursos</a> > Modificar recurso</h2>
	...
	<tr>
          ...
          <td><html:text readonly="true" property="codigoRecurso" /></td>
	</tr>
	<tr>
