...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
	...
	<div id="sectionLinks">
    <a href="ClientesList.do">Volver atrás</a>	
    </div>
	<div id="error">
	<html:errors />
	</div>
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="ClientesList.do">Clientes</a> > Modificar cliente</h2>
	<h3>Datos del cliente</h3><hr><br>
	

    <html:form action="/EditCliente"
      name="clienteForm"
