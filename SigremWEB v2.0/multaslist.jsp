...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
	...
	<div id="sectionLinks">
	<a href="addmulta.jsp">Añadir multa</a>
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="ContratosList.do">Contratos</a> > Ver Multas</h2>
	...
	<tr align="center">
	  ...
	  <td>
            <a href="EditM.do?codigo=<bean:write name="multa"
	      property="codigoMulta" />"><img src="images/tick.gif" alt="Modificar multa" /></a>
		  </td>
		  <td>
	    <a href="DeleteMulta.do?codigo=<bean:write name="multa"
	      property="codigoMulta" />"><img src="images/del.gif" alt="Eliminar multa" /></a>
	  </td>
	  <td><div id="boton">
	    <a href="RecursosList.do?codigomu=<bean:write name="multa"
