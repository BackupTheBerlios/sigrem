...
<div id="pagecell1"> 
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="ContratosList.do">Contratos</a> > <a href="MultasList.do">Ver Multas</a> > Modificar multa</h2>
	<h3>Datos de la multa</h3><hr><br>
	...
	<tr>
          ...
          <td><html:text readonly="true" property="codigoMulta" /></td>
	</tr>
	<tr>
          <td><bean:message key="app.expediente" />:</td>
          <td><html:text readonly="true" property="expediente" /></td>
	</tr>
	<tr>
	  <td><bean:message key="app.boletin" />:</td>
          <td><html:text readonly="true" property="boletin" /></td>
        </tr>
	</tr>
