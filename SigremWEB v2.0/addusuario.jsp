...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
    ...
    <html:form action="/AddUsuario" name="usuarioForm" type="login.UsuarioForm" >
	...
	<p>
	<bean:message key="app.passwordr" />
	</p>
	<p>
	<html:password property="passwordRepe" />
	</p>
	<p>
	<bean:message key="app.tipousuario" />
	</p>
	<p>
	...
	<p><html:submit value="Hecho" /> &nbsp;<html:cancel value="Cancelar" /></p>
