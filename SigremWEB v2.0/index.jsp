...
<body> 
<div id="masthead"> 
  <h1 id="siteName">SigremWEB v2.0</h1> 
  <div id="globalNav"> 
...
<div id="pagecell1"> 
  ...
  <div id="content"> 
    ...
    <div class="story"> 
	  ...
	  <h2>Autores</h2> 
      <p>
       	La aplicación ha sido desarrollada por: <br>
		<br>
		• Félix Martos Trenado<br>
		• Javier Rodríguez Horcajo<br>
		• Miguel Ángel Ruiz Ortega<br>
		• Francisco José Sánchez Hernando<br>
		• Sergio Tarancón Faus<br>
		<br>
      </p>
    </div> 
