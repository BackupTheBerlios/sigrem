...
<div id="pagecell1"> 
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="EmpleadosList.do">Empleados</a> > Modificar Empleado</h2>
	<h3>Datos del empleado</h3><hr><br>
	


     <html:form action="/EditEmpleado"
      name="empleadoForm"
	...
	<tr>
	  ...
	  <td><bean:message key="app.perfil" />:</td>
          <td><html:text readonly="true" property="perfil" /></td>
        </tr>
	<tr>
