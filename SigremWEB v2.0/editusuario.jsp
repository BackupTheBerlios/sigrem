...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
	...
	<div id="sectionLinks">
    <a href="UsuariosList.do">Volver atrás</a>	
    </div>
	<div id="error">
	<html:errors />
	</div>
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="UsuariosList.do">Usuarios</a> > Modificar Usuario</h2>
	<h3>Datos del usuario</h3><hr><br>
	...
	<tr>
          ...
          <td><html:text readonly="true" property="nombreUsuario" /></td>
	</tr>
	<tr>
	...
	<tr>
	  <td><bean:message key="app.tipousuario" />:</td>
          <td><html:text readonly="true" property="tipoUsuario" /></td>
        </tr>
