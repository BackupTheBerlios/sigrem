...
<div id="pagecell1"> 
  ...
  <div id="content">     
	<div class="feature"> 
	<h2><a href="administrador.html">P&aacute;gina Administrador</a> > <a href="ContratosList.do">Contratos</a> > Modificar Contrato</h2>
	...
	<tr>
          ...
          <td><html:text readonly="true" property="codigoContrato" /></td>
	</tr>
	<tr>
          <td><bean:message key="app.matricula" />:</td>
          <td><html:text readonly="true" property="matricula" /></td>
	</tr>
	...
	<tr>
          ...
          <td><html:text readonly="true" property="codigoCliente" /></td>
	</tr>
	</table>
</div>
<hr>
