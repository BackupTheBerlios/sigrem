...
public class ModificaUsuarioAction extends Action
{
	protected void modificarUsuario(UsuarioForm form, HttpServletRequest request) throws Exception 
	{
		...
		UsuarioBaseDatos.modificaUsuario(usuario, getDataSource(request));
	}
			...
			HttpServletResponse response) throws IOException, ServletException 
	{
		...
		try 
		{	modificarUsuario((UsuarioForm) form, request);}
		catch ( Exception e ) 
