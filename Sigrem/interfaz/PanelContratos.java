...
public class PanelContratos extends JPanel
{
	...
	public JPanel dibujaCliente()
	{
		...
		relleno1.setPreferredSize(new Dimension(120,20));
		relleno2.setPreferredSize(new Dimension(110,20));
		relleno3.setPreferredSize(new Dimension(20,20));
		relleno4.setPreferredSize(new Dimension(120,20));
		relleno5.setPreferredSize(new Dimension(50,20));
		...
		tdni.setPreferredSize(new Dimension(50,20));
		tdir.setPreferredSize(new Dimension(180,20));
		tcp.setPreferredSize(new Dimension(60,20));
		tloc.setPreferredSize(new Dimension(180,20));
		tpro.setPreferredSize(new Dimension(140,20));
		ttel.setPreferredSize(new Dimension(80,20));
		temail.setPreferredSize(new Dimension(100,20));
